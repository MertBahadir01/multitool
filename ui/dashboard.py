...
#    ],
    ...
    "finance": [
        ("🏠", "Finance Dashboard",    "Genel finansal özet",          "finance_dashboard"),
        ("💸", "Expense Tracker",      "Harcama takibi ve kategoriler","expense_tracker"),
        ("📊", "Budget App",           "Bütçe limitleri ve kalan",     "budget_app"),
        ("🏦", "Loan Calculator",      "Kredi ödemesi ve plan",        "loan_calculator"),
        ("🎯", "Savings Tracker",      "Birikim hedefleri",            "savings_tracker"),
        ("📈", "Portfolio Tracker",    "Hisse portföyü ve K/Z",        "portfolio_tracker"),
        ("🔔", "Subscription Tracker", "Abonelik giderleri",           "subscription_tracker"),
        ("💱", "Currency Converter",   "TRY bazlı döviz çevirici",     "currency_converter"),
        ("🧾", "Invoice Tool",         "Fatura oluştur ve PDF çıkt",   "invoice_tool"),
        ("🧾", "Tax Calculator",       "Türkiye gelir vergisi 2024",   "tax_calculator"),
        ("₿",  "Crypto Tracker",       "Kripto para takibi",           "crypto_tracker"),
        ("🔍", "Spending Analyzer",    "Harcama kalıpları analizi",    "spending_analyzer"),
        ("💎", "Net Worth Tracker",    "Varlık eksi borç = servet",    "net_worth_tracker"),
        ("📅", "Bill Reminder",        "Fatura ve ödeme hatırlatıcı",  "bill_reminder"),
        ("📊", "Investment Simulator", "Bileşik faiz simülasyonu",     "investment_simulator"),
        ("💳", "Debt Tracker",         "Borç ve geri ödeme takibi",    "debt_tracker"),
        ("🏖️", "Retirement Planner",   "Emeklilik tasarrufu planı",    "retirement_planner"),
        ("💹", "Cash Flow",            "Aylık gelir-gider akışı",      "cash_flow"),
        ("🎯", "Goal Planner",         "Finansal hedef ve geri sayım", "goal_planner"),
        ("🧾", "Receipt Scanner",      "Fiş fotoğrafından OCR",        "receipt_scanner"),
    ],
    "security": [
